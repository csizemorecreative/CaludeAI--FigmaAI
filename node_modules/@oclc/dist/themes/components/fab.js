...
export const MuiFab = {
    ...
    styleOverrides: {
        root: {
            ...
            height: 'unset',
            '&:hover': {
                background: tokenData.tokens.palette.blue.blue800
            },
            '&.Mui-focusVisible': {
                background: tokenData.tokens.palette.blue.blue800,
                outline: `2px solid ${tokenData.tokens.palette.text.text300}`,
                outlineOffset: '2px',
            ...
            '&.Mui-disabled': {
                background: tokenData.tokens.palette.grey.disabled,
