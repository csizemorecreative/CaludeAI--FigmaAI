...
export const MuiDataGrid = {
    defaultProps: {
        slots: {
            filterPanelDeleteIcon: MinusCircleOutline
        },
        slotProps: {
            baseTextField: {
                variant: 'outlined',
    ...
    styleOverrides: {
        root: ({ theme }) => ({
            ...
            '& [class*=MuiTablePagination-select], .MuiTablePagination-input': {
                marginRight: 8
            },
            ...
            '& .MuiInputBase-root:not([class*=MuiSelect-root])': {
                '&.Mui-error': {
                    borderColor: tokenData.tokens.palette.red.red600,
                    boxShadow: '0px 0px 0px 2px rgba(196, 32, 20, 0.5)',
                    '& .MuiOutlinedInput-notchedOutline': {
                        border: `1px solid ${tokenData.tokens.palette.red.red600}`
                    }
                }
            },
            ...
            '& .MuiDataGrid-toolbarContainer': {
                ...
                paddingLeft: '12px',
                paddingRight: '12px',
                borderBottom: `1px solid ${tokenData.tokens.palette.grey.grey300}`,
                rowGap: 6,
            ...
            '& .MuiDataGrid-row--detailPanelExpanded': {
                '& .MuiDataGrid-cell[data-colindex="0"]:first-of-type': {
                    position: 'relative',
                    '&:before': {
                        content: '" "',
                        position: 'absolute',
            ...
            '&.OclcDataGrid-striped-alt': {
                '& .MuiDataGrid-row:nth-of-type(odd):not(.Mui-selected)': {
                    backgroundColor: lighten(tokenData.tokens.palette.grey.grey100, 0.25),
                    '&:not(.MuiDataGrid-row--editing):hover': {
                        backgroundColor: darken(tokenData.tokens.palette.grey.grey100, 0.025)
                    }
                }
            },
            '&.OclcDataGrid-responsive': {
                '& .MuiDataGrid-row:not(.MuiDataGrid-row--editing):not(.Mui-selected):hover': {
                    backgroundColor: darken(tokenData.tokens.palette.grey.grey100, 0.025)
                },
                ...
                [theme.breakpoints.down('sm')]: {
                    ...
                    '& .MuiDataGrid-row, .MuiDataGrid-cell, .MuiDataGrid-virtualScrollerRenderZone': {
                        display: 'block',
                        maxWidth: 'none !important',
                        width: '100%',
                        flexWrap: 'wrap !important'
        ...
        panelContent: ({ theme }) => ({
            ...
            '& :not(.MuiDataGrid-filterForm:first-of-type)': {
        ...
        filterForm: {
            ...
            '& .MuiDataGrid-filterFormDeleteIcon': {
                marginRight: 0,
                '& .MuiIconButton-root': {
                    color: tokenData.tokens.palette.darkBlue.darkBlue600,
                    '& .MuiSvgIcon-root': {
                        fontSize: 20
                    }
                }
                ...
                '& .MuiInputBase-root': {
                    '& .MuiNativeSelect-select': {
                        ...
                        '&.Mui-disabled': {
                            ...
                            WebkitTextFillColor: tokenData.tokens.palette.text.text200,
