...
export const MuiCard = {
    variants: [
        {
            ...
            style: {
                background: tokenData.tokens.palette.grey.grey100,
                border: `1px solid ${tokenData.tokens.palette.grey.grey200}`,
    ...
    styleOverrides: {
        root: {
            ...
            '&.MuiPaper-outlined': {
                border: `1px solid ${tokenData.tokens.palette.grey.grey300}`,
                boxShadow: 'none'
            },
            '&.MuiPaper-callout': {
                '& ul': {
...
export const MuiCardActions = {
    ...
    styleOverrides: {
        root: ({ theme }) => ({
            ...
            borderTop: `1px solid ${tokenData.tokens.palette.grey.grey200}`,
